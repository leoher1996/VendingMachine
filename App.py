...
vending_mqtt = broker.broker(broker_adr="64.227.111.82", topic="general/vending_lw", client_name="vending_lw_001", port=1884)
vending_mqtt.client_init()
vending_mqtt.client_connect()
vending_mqtt.client_subscribe()
...
class WindowBuy(QDialog):
    ...
    def InitUI(self):
        ...
        if (len(self.InventoryProduct)==0):
            ...
            vending_mqtt.client_connect()			
            vending_mqtt.client_publish(f"[{vending_mqtt.client_name}] unit is empty. Please restock.")
